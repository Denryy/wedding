...
const CONFIG = {
  ...
  hero: {
    ...
    separator:   " & ",
    date:        "26 · VIІІ · 2026",         // Дата на обложке (оформление свободное)
  },
  ...
  ── ── ── ── ── ── ── ── ── ── ── ── ── ── ── ── */
  event: {
    datetime:     "2026-08-26T18:00:00",   // ← МЕНЯЙ ДАТУ ЗДЕСЬ
    dateDisplay:  "26 тамыз 2026 жыл",    // Текст даты в блоке
    timeDisplay:  "18:00",                 // Время начала
    sectionTitle: "Той күні мен уақыты",
    note: "Тойымыздың 18:00-де басталып кететінін ескере отырып, тойға кешікпей келулеріңізді өтінеміз!",
  },
  ...
  invitation: {
    ...
    text:     "Сіздерді перзенттеріміздің үйлену тойына шын жүректен шақырамыз. Бізбен бірге осы қуанышты сәтке ортақтасып, батаңыздарды беруіңізді сұраймыз.",
  },
    ...
    list: [
      {
        ...
        name: "Қасымов Болат Серікұлы\nжәне Зауреш Маратқызы",
        wide: false,
      },
      {
        role: "Қыз жағынан",
        name: "Жақсыбеков Ержан Нұрланұлы\nжәне Гүлнар Сейітқызы",
        wide: false,
      },
    ],
  },
